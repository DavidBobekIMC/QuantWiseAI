...
\chapter{Experimentation}
	...
	\section{Machine Learning models}
		\subsection{Neural Network (LSTM)} 
			...
			that I am using. In order to have better results I am than scaling the data using an inverse_transform function which does the opposite of the scaling function and scales the data back to its original form. 
			...
			Some metrics over the 6 splits are the following, 6 columns and 4 rows. 2 for RMSE (Train and Test data)  and 2 for R2 score (Train and Test data). Table
			\begin{table}[h!]
				\centering
