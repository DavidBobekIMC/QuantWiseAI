...
\chapter{Conclusion}
	...
	\section{Technical Indicators}
		...
		\subsubsection{Is it possible to predict the future price of the stock market based on historical data?}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=0.8\textwidth]{equity_curve_rsi.png}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=0.8\textwidth]{equity_curve_bollinger_bands.png}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=0.8\textwidth]{equity_curve_rolling_windows.png}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=0.8\textwidth]{equity_curve_moving_averages.png}
